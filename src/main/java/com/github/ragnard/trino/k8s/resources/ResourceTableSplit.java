...
public record ResourceTableSplit(
        @JsonProperty("tableHandle") ResourceTableHandle tableHandle)
        implements KubernetesSplit
{
    private static final int INSTANCE_SIZE = SizeOf.instanceSize(ResourceTableSplit.class);

...
public record KubernetesResourceTableHandle(
        ...
        implements KubernetesTableHandle
{
    ...
    public KubernetesResourceTableHandle(SchemaTableName schemaTableName)
    {
    ...
    {
        return new KubernetesResourceTableHandle(schemaTableName, newConstraint, limit);
    }

    public KubernetesTableHandle withLimit(int newLimit)
    {
        return new KubernetesResourceTableHandle(schemaTableName, constraint, OptionalInt.of(newLimit));
    }

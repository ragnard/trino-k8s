        ...
        implements ConnectorMetadata
{
    ...
    public ConnectorTableMetadata getTableMetadata(ConnectorSession session, ConnectorTableHandle tableHandle)
    {
        return switch ((KubernetesTableHandle) tableHandle) {
            case KubernetesResourceTableHandle h -> this.kubernetesClient.lookupTableOrThrow(h).getTableMetadata();
    ...
    {
        return switch ((KubernetesTableHandle) tableHandle) {
            case KubernetesResourceTableHandle h -> this.kubernetesClient.lookupTableOrThrow(h).getColumnHandles();
            default -> throw new IllegalStateException("Unexpected value: " + tableHandle);
        };
    }
    ...
    {
        return switch ((KubernetesTableHandle) tableHandle) {
            case KubernetesResourceTableHandle h -> this.kubernetesClient.lookupTableOrThrow(h).getColumnMetadata((KubernetesColumnHandle) columnHandle);
